...
class ConveyanceAwaitingScreen extends StatelessWidget {
  final ApiService apiService;
  final GlobalKey<ScaffoldState> scaffoldKey;
  final User currentUser;
  const ConveyanceAwaitingScreen({
    Key key,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 5,),
                                        Text(
                                          'Name : ${myConveyanceList[idx].employeeName}', //${_colleagues[idx].code}
                                          style: TextStyle(
                                            color: Colors.black45,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 12,
                                        ...
                                        //         //                     onPressed: () {
                                        //         //                       Navigator.of(context).pop();
                                        //         //                       Navigator.of(context).pushNamed(RESIGNATION_PAGE,arguments:ConveyancePageScreen.ConveyanceAwaiting);
                                        //         //                     },
                                        //         //                   ),
                                        //         //                 ],
                                        //         //               );
