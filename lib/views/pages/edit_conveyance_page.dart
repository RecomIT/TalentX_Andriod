...
class EditConveyancePage extends StatefulWidget {
  final Conveyance myConveyance;
  const EditConveyancePage({
    Key key,
    this.myConveyance,
  }) : super(key: key);
...
class _EditConveyanceScreenState extends State<EditConveyancePage> {
  ...
  EditConveyanceInfo conveyanceInfo =new EditConveyanceInfo();
  Future<EditConveyanceInfo> _conveyanceInfo;
  ...
  void initState() {
    ...
    _requestId = widget.myConveyance.id;

    conveyanceInfo = EditConveyanceInfo();
    _getCurrentDateFormat();
    _conveyanceInfo = _apiService.getEditConveyanceInfo(_requestId);
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: FutureBuilder<EditConveyanceInfo>(
                      ...
                      if (snapshot.hasData && !snapshot.hasError) {
                        ...
                        if(conveyanceInfo == null){
                          ...
                          /// Initializing Values
                           ...
                           description= conveyanceInfo.conveyance.description;
                           payment_method=conveyanceInfo.conveyance.paymentMethod;
                          _isPaymentMethodChanged=true;

                          switch(payment_method.toLowerCase()) {
                            case 'bank': {
                              _isBankPaymentMethod=true;
                              bank_name=conveyanceInfo.conveyance.bankName;
                              bank_account_name=conveyanceInfo.conveyance.bankAccountName;
                              bank_account_number=conveyanceInfo.conveyance.bankAccountNumber;
                              bank_branch_name=conveyanceInfo.conveyance.branchName;
                              routing_no=conveyanceInfo.conveyance.routingNo;
                            }break;
                            case 'nagad': {
                              _isBankPaymentMethod=false;
                              account_name=conveyanceInfo.conveyance.accountName;
                              account_number=conveyanceInfo.conveyance.accountNumber;
                            } break;
                            default:{
                              _isBankPaymentMethod = false;
                              bank_name=null;
                            ...
                            business_head_employee_id= conveyanceInfo.conveyance.businessHeadEmployeeId.toString();
                            final_approver_id = conveyanceInfo.conveyance.finalApproverId.toString();

                            conveyanceInfo.conveyance.conveyanceDetails.forEach((e) {
                              conveyanceVM.travel_date.add(dateFormatter.format(DateTime.parse(e.travelDate)));
                              conveyanceVM.id=conveyanceInfo.conveyance.conveyanceDetails.length??0;
                              conveyanceVM.purpose.add(e.purpose);
                              conveyanceVM.mode_of_transport.add(e.modeOfTransport);
                              conveyanceVM.transport.add(e.transport.toDouble());
                              conveyanceVM.food.add(e.food.toDouble());
                              conveyanceVM.other.add(e.other.toDouble());
                              conveyanceVM.total.add(e.total.toDouble());
                              conveyanceVM.location.add(e.location);
                              conveyanceVM.remarks.add(e.remarks);
                              if (e.attachment != 'N/A') {
                                conveyanceVM.attachments.add(AttachmentModel(attachmentURL: e.attachment));
                              }
                              else{
                                conveyanceVM.attachments.add(AttachmentModel(attachmentURL: null));
                              }

                              costCenterList = conveyanceInfo.costCenters.businessUnitWiseCostCenter.toList();
                              // conveyanceInfo.selectedCostCenter=["Founders","Tech"];
                              costCenterIds = conveyanceInfo.selectedCostCenter;
                              ...
                              Form(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    SizedBox(height: 20,),
                                    Text(
                                      "Reference No : ${conveyanceInfo.conveyance.referenceNo}",
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 11,
                                    ...
                                    SizedBox(height: 5,),
                                    Text(
                                      "Ticket Raise Date : ${conveyanceInfo.conveyance.applicationDate}",
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 11,
                                        color: Colors.black54,
                                    ...
                                    // SizedBox(height: 5,),
                                    // Text(
                                    //   "Employee ID : ${conveyanceInfo.conveyance.employeeId??'N/A'}", //conveyanceInfo.employee.code?
                                    //   style: TextStyle(
                                    //     fontWeight: FontWeight.bold,
                                    //     fontSize: 11,
                                    //     color: Colors.black54,
                                    ...
                                    SizedBox(height: 5,),
                                    Text(
                                      "Employee Name : ${_currentUser.name??'N/A'}",  //conveyanceInfo.employee.fullName
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 11,
                                        color: Colors.black54,
                                    ...
                                    SizedBox(height: 5,),
                                    Text(
                                      "Division : ${conveyanceInfo.conveyance.division.name ??'N/A'}", //conveyanceInfo.employee.division.name
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 11,
                                        color: Colors.black54,
                                    ...
                                    SizedBox(height: 5,),
                                    Text(
                                      "Department : ${conveyanceInfo.conveyance.department.name ??'N/A'}", //conveyanceInfo.employee.department.name
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 11,
                                        color: Colors.black54,
                                    ...
                                    SizedBox(height: 5,),
                                    Text(
                                      "Cost Center : ${conveyanceInfo.conveyance.costCenter.name??'N/A'}", //conveyanceInfo.employee.costCenter.name
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 11,
                                        color: Colors.black54,
                                    ...
                                    SizedBox(height: 5,),
                                    Text(
                                      "Contact No : ${conveyanceInfo.conveyance.contactNo??'N/A'}", //conveyanceInfo.employee.phone
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 11,
                                        color: Colors.black54,
                                                                  ...
                                                                  child: Container(
                                                                    ...
                                                                    child:Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        //SizedBox(height: 10,),
                                                                        conveyanceVM.attachments[index].attachmentURL != null ?
                                                                        InkWell(
                                                                          onTap:  () async {
                                                                            var url = conveyanceVM.attachments[index].attachmentURL??'N/A';
                                                                            print(url);
                                                                          ...
                                                                          child: Row(
                                                                            children: [
                                                                              Text('Attachment Download: ', style: TextStyle(color: Colors.black45, fontWeight: FontWeight.bold, fontSize: 10,)),
                                                                              Container(
                                                                                width: 30,
                                                                                //height: 30,
                                                                                padding:
                                    ...
                                    SizedBox(height: 10),
                                    NeomorphicTextFormField(
                                    initVal: 'CC : ${conveyanceInfo.conveyance.hrGroup} ',
                                    inputType: TextInputType.text,
                                    hintText: "CC :",
                                    isReadOnly: true,
                                    fontSize: 12,
                                    ...
                                    NeomorphicTextFormField(
                                      inputType: TextInputType.text,
                                      initVal: 'First Approver : ${conveyanceInfo.conveyance.supervisor.fullName} (${conveyanceInfo.conveyance.supervisor.code}) ',
                                      ...
                                      onTapFunction: () async {
                                        ...
                                        try {
                                          ...
                                          var formData = FormData.fromMap({
                                            "id": conveyanceInfo.conveyance.id,
                                          ...
                                          final response = await _apiService.applyForEditConveyance(formData);
