...
class EditTravelPlanPage extends StatefulWidget {
  ...
  @override
  _EditTravelPlanScreenState createState() => _EditTravelPlanScreenState();
}

class _EditTravelPlanScreenState extends State<EditTravelPlanPage> {
  ...
  final workPlaceList = <TravelType>[
    ...
    new TravelType(id: 'Outstation', value: 'outstation', name: 'Work places other than base station where the employees need to stay at night. Applicable for the stations out of Dhaka City')
  ];
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            underline: SizedBox(),
                            value:
                                travelTypeList.isNotEmpty ? typeOfTravel : null,
                            hint: Text(
                              'Select Travel Type',
                              style: TextStyle(
                                  fontSize: 12,
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            isDense: true,
                            underline: SizedBox(),
                            value: travelPurposesList.isNotEmpty
                                ? travelPurpose
                                : null,
                            //travelPurpose,
                            hint: Text(
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            isDense: true,
                            underline: SizedBox(),
                            value: travelTransportModesList.isNotEmpty
                                ? transportMode
                                : null,
                            //'by-air' transportMode
                            hint: Text(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    ...
                                    color: Colors.black26,
                                    offset:
                                        Offset.fromDirection(Math.pi * .25, 5),
                                  ),
                                ],
                              ),
                              child: Container(
                                ...
                                child: DropdownButton<String>(
                                  isDense: true,
                                  underline: SizedBox(),
                                  value: currencyList.isNotEmpty ? currency : null, //currency,
                                  hint: Text(
                                    'Select Currency',
                                    style: TextStyle(
                                        fontSize: 12,
                        ...
                        children: [
                          ...
                          NeomorphicDatetimePicker(
                            ...
                            updateValue: (String to) {
                              setState(() {
                                endDate =
                                    dateFormatter.format(DateTime.parse(to));
                            ...
                            DropDownField(
                              onValueChanged: (dynamic value) {
                                setState(() {
                                  ...
                                  bool isAlreadyExist =
                                      travellers.contains(traveller);
                                  if (!isAlreadyExist) {
                                    var travellerId = travellerList
                                        .firstWhere(
                                            (e) => e.name == traveller.trim())
                                        .id;
                                    travellers.add(traveller);
                                    travellerIds.add(travellerId);
                                  }
                                  print('travellers : ' +
                                      travellers.toList().toString());
                                });
                              },
                              //enabled: true,
                              strict: false,
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            isDense: true,
                            underline: SizedBox(),
                            value: tripTypeList.isNotEmpty ? tripType : null, //tripType,
                            hint: Text(
                              'Select Trip Type',
                              style: TextStyle(
                                  fontSize: 12,
                            ...
                            items: List<DropdownMenuItem<String>>.generate(
                              ...
                              (idx) => DropdownMenuItem<String>(
                                value:
                                    idx == 0 ? null : tripTypeList[idx - 1].id,
                                //domestic
                                child: Container(
                                  width:
                                      MediaQuery.of(context).size.width * 0.6,
                                    ...
                                    onValueChanged: (dynamic value) {
                                      setState(() {
                                        ...
                                        if (fromDestination != null) {
                                          var from = destinationList.firstWhere(
                                              (e) => e.name
                                                  .contains(fromDestination),
                                              orElse: null);
                                          fromDestinationId =
                                              int.tryParse(from.id);
                                          print('fromDestination: ' +
                                              fromDestination.toString() +
                                              ' || fromDestinationId: ' +
                                              fromDestinationId.toString());
                                        }
                                      });
                                    },
                                    //enabled: true,
                                    ...
                                    onValueChanged: (dynamic value) {
                                      setState(() {
                                        ...
                                        if (toDestination != null) {
                                          var to = destinationList.firstWhere(
                                              (e) => e.name
                                                  .contains(toDestination),
                                              orElse: null);
                                          toDestinationId = int.tryParse(to.id);
                                          print('toDestination: ' +
                                              toDestination.toString() +
                                              ' || toDestinationId: ' +
                                              toDestinationId.toString());
                                        }
                                      });
                                    },
                                    //enabled: true,
                ...
                Form(
                  ...
                  child: Column(
                    children: [
                              ...
                              children: [
                                        ...
                                        itemBuilder: (context,index){
                                          return Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    'Ceiling For Accommodation (Those who will have night stay during office assignments)',
                                                    style: TextStyle(
                                                        color: Colors.white),
                                                  ),
                                                  SizedBox(height: 5),
                                ...
                                Visibility(
                                  ...
                                  child: Container(
                                      ...
                                      padding: EdgeInsets.symmetric(
                                          vertical: 10, horizontal: 10),
                                      child: Text('Upto BDT. 1,000 for Outstation including local transport',
                                        style: TextStyle(color: Colors.white),)
                                  ),
                                ),
                                SizedBox(height: 10,),
                                    ...
                                    Checkbox(
                                      ...
                                      onChanged: (newValue) {
                                        setState(() {
                                          ...
                                          print('transferAllowance : ' +
                                              transferAllowance.toString());
                                        });
                                      },
                                    ),
                                  ...
                                  Checkbox(
                                    ...
                                    onChanged: (newValue) {
                                      setState(() {
                                        ...
                                        print('guestHouseAccommodation : ' +
                                            guestHouseAccommodation.toString());
                                      });
                                    },
                                  ),
                              ...
                              Visibility(
                                ...
                                child: Container(
                                    ...
                                    padding: EdgeInsets.symmetric(
                                        vertical: 10, horizontal: 10),
                                    child: Text(
                                      'Upto US \$75/day (for lunch and dinner including all VAT/SC)',
                                      style: TextStyle(color: Colors.white),
                                    )),
                              ),
                            ]),
                      ...
                      //       isDense: true,
                      //       underline: SizedBox(),
                      //       value: ccList.isNotEmpty ? hrGroup : null,//hrGroup,
                      //       hint: Text(
                      //         'Select CC',
                      //         style: TextStyle(
                      //             fontSize: 12,
                      ...
                      //         (ccList?.length ?? 0) + 1,
                      //         (idx) => DropdownMenuItem<String>(
                      //           value: idx == 0 ? null : ccList[idx - 1].id,
                      //           //domestic
                      //           child: Container(
                      //             width:
                      //                 MediaQuery.of(context).size.width * 0.6,
                            ...
                            DropDownField(
                              onValueChanged: (dynamic value) {
                                setState(() {
                                  ...
                                  bool isAlreadyExist =
                                  costCenters.contains(costCenter);
                                  if (!isAlreadyExist) {
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            isDense: true,
                            underline: SizedBox(),
                            value: businessHeadList.isNotEmpty ? firstApprover : null, //firstApprover,
                            hint: Text(
                              '1ST APPROVER (BUSINESS HEAD)',
                              style: TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.grey[500]),
                            ...
                            onChanged: (String value) {
                              setState(() {
                                ...
                                if (firstApprover != null) {
                                  ...
                                  print(
                                      'firstApprover BSHead: ' + firstApprover);
                                }
                              });
                            },
                          ),
                          ...
                          ? Container(
                              ...
                              child: Container(
                                ...
                                child: DropdownButton<String>(
                                  isDense: true,
                                  underline: SizedBox(),
                                  value: ceoList.isNotEmpty ? secondApprover : null,//secondApprover,
                                  hint: Text(
                                    'Select 2nd Approver',
                                    style: TextStyle(
                                        fontSize: 12,
                                  ...
                                  onChanged: (String value) {
                                    setState(() {
                                      ...
                                      if (secondApprover != null) {
                                        authorityTwo =
                                            int.tryParse(secondApprover);
                                        print('secondApprover CEO: ' +
                                            secondApprover);
                                      }
                                    });
                                  },
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            isDense: true,
                            underline: SizedBox(),
                            value: financeBpList.isNotEmpty ? finalApprover : null,//finalApprover,
                            hint: Text(
                            ...
                            items: List<DropdownMenuItem<String>>.generate(
                              ...
                              (idx) => DropdownMenuItem<String>(
                                value:
                                    idx == 0 ? null : financeBpList[idx - 1].id,
                                //domestic
                                child: Container(
                                  width:
                                      MediaQuery.of(context).size.width * 0.6,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text("Successfully Updated Travel Plan!!!"),
          actions: [
            FlatButton(
              child: new Text("OK"),
              onPressed: () {
                Navigator.of(context).pop();
                Navigator.of(context).pushNamed(TRAVEL_PLAN_PAGE,
                    arguments: TravelPlanPageScreen.TravelPlans);
              },
            ),
          ],
        );
              ...
              children: [
                DropDownField(
                  onValueChanged: (dynamic value) {
                    setState(() {
                      if (value != null) {
                        var destination = destinationList.firstWhere(
                            (e) => e.name.contains(value),
                            orElse: () => null);
                        var destinationId = int.tryParse(destination.id);
                        print('multiFromDestination: ' +
                            destination.name +
                            ' || multiFromDestinationId: ' +
                    ...
                    setState(() {
                      if (value != null) {
                        var destination = destinationList.firstWhere(
                            ...
                            orElse: () => null);
                        var destinationId = int.tryParse(destination.id);
                        print('multiToDestination: ' +
                            destination.name +
                            ' || multiToDestinationId: ' +
                            destinationId.toString());
                          ...
                          children: [
                            Row(
                              children: [
                                Flexible(
                                    child: Text(
                                  'From : ' + multiCityFormList[index].FromName,
                                  style: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.normal,
                            ...
                            Row(
                              children: [
                                Text(
                                  'From Date : ' +
                                      multiCityFormList[index].FromDate,
                                  style: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.normal,
                                      color: Colors.black54),
                            ...
                            Row(
                              children: [
                                Flexible(
                                    child: Text(
                                  'To : ' + multiCityFormList[index].ToName,
                                  style: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.normal,
                                      color: Colors.black54),
                            ...
                            Row(
                              children: [
                                Text(
                                  'To Date : ' +
                                      multiCityFormList[index].ToDate,
                                  style: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.normal,
                                      color: Colors.black54),
                                ...
                                InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    setState(() {
                                      ...
                                      _multiFormCounter--;
                                      print('multiCityForm Removed : ' +
                                          item.FromName +
                                          'multiCityTo : ' +
                                          item.ToName);
                                      print('multiCityFormList length : ' +
                                          multiCityFormList.length.toString());
                                    });
                                  },
                                ),
                              ],
  ...
  void _generateReference() async {
    var response =
        await _apiService.getReferenceCode(typeOfTravel, travelPurpose);
    setState(() {
  ...
  void _generateTransportModeList() async {
    ...
    setState(() {
      ...
      try {
        var othersMode = travelTransportModesList
            .singleWhere((e) => e.id == 'others', orElse: null);
        if (othersMode != null) {
          othersMode.name =
              'Other Modes of Transport (Ride Sharing, CNG, Rickshaw etc.)';
        }
      } catch (e) {}
  ...
  void validateFirstStep() {
    ...
    if (typeOfTravel.toLowerCase().contains('domestic') &&
        checkNullorEmpty(workPlace)) {
      showSnackBarMessage(
        scaffoldKey: _scaffoldKey,
    ...
    if (typeOfTravel.toLowerCase().contains('international') &&
        checkNullorEmpty(currency)) {
      showSnackBarMessage(
        scaffoldKey: _scaffoldKey,
    ...
    if (tpEndDate.isBefore(tpStartDate)) {
      showSnackBarMessage(
        scaffoldKey: _scaffoldKey,
        message:
            "Invalid Date selection! Start Date can't be greater then End Date",
        fillColor: Colors.red,
      );
      return;
    }
  ...
  void validateMultiCityForm() {
    ...
    setState(() {
      ...
      multiCityForm.Id = id;
      var item =
          multiCityFormList.firstWhere((e) => e.Id == id, orElse: () => null);
      if (item == null) {
        multiCityFormList.add(multiCityForm);
        _multiFormCounter++;
        print('multiCityForm : ' +
            multiCityForm.FromName +
            'multiCityTo : ' +
            multiCityForm.ToName);
        print('multiCityFormList length : ' +
            multiCityFormList.length.toString());
        multiCityForm = MultiCityForm();
        mcStartDate = null;
  ...
  void generateFormAndSubmit() async {
    ...
    if (attachmentContent != null) {
      var file = await MultipartFile.fromFile(attachmentPath,
    ...
    try {
      final response = await _apiService.applyForUpdateTravelPlan(formData);
  ...
  void _setInitialValues() async {
    ...
    var res = await _apiService.getEditTravelPlan(widget.travelPlan.id.toString());
    travelplanid= widget.travelPlan.id.toString();
    referenceNo = res.referenceNo;
    typeOfTravel = res.travelType;
    description = res.description;
    _isWorkPlaceVisible = typeOfTravel.toLowerCase().contains('domestic') ? true : false;
    _isCurrencyVisible =  typeOfTravel.toLowerCase().contains('domestic') ? false : true;

    if(_isWorkPlaceVisible){
      workPlace = res.workPlace;
      // _radioValue = workPlace.toLowerCase().contains('ex') ? 1 : 2;
      _radioValue=1; // Outstation Fixed
      workPlaceDescription = workPlaceList[_radioValue - 1].name;
    }
    ...
    travelPurpose = res.purpose;
    transportMode= res.transportMode;
    _isAirTransportMode = transportMode.toLowerCase().contains('air') ? true : false;
    //transportMode = 'Other Modes of Transport (Ride Sharing, CNG, Rickshaw etc.)'.toLowerCase().replaceAll(' ', '-');
    //transportMode = transportMode.contains('other') ? 'others' : transportMode;

    var responseDateFormat = await _apiService.getCurrentDateFormat();
    setState(() {
      currentDateFormat = responseDateFormat.trim().toLowerCase();
      switch (currentDateFormat) {
    ...
    endDate = res.endDate;
    tpStartDate = dateFormatter.parse(startDate);
    tpEndDate = dateFormatter.parse(endDate);

    tripType = res.tripType;

    var responseTravellers = await _apiService.getTravellers();
    setState(() {
      travellerList = responseTravellers.travelType.toList();
    });

    var responseCostCenters = await _apiService.getCostCenter();
    setState(() {
      costCenterList = responseCostCenters.businessUnitWiseCostCenter.toList();
    });


    travellerIds = res.traveller; //['1','2'];
    costCenterIds = res.costCenter; // ["a","b"]

    if(travellerIds.length > 0 ){
      var tvList = travellerList.where((e) => travellerIds.contains(e.id)).toList();
      travellers = tvList.map((e) => e.name).toList();
    }

    if(costCenterIds.length > 0 ){
      var ccList = costCenterList.where((e) => costCenterIds.contains(e.id)).toList();
      costCenters = ccList.map((e) => e.name).toList();
    }


    var responseDestinations = await _apiService.getDestinations(typeOfTravel);
    setState(() {
      destinationList = responseDestinations.travelType.toList();
    });
    ...
    if (tripType.contains('multi-city')) {
      ...
      res.travelRoutes.forEach((e) {
        multiFromDestinationId.add(e.fromTravelDestinationId);
        multiToDestinationId.add(e.toTravelDestinationId);
        multiFromDestinationDate.add(e.startDate);
        multiToDestinationDate.add(e.endDate);

        var obj =  MultiCityForm();
        var from  = destinationList.firstWhere((d) => d.id== e.fromTravelDestinationId.toString());
        var to = destinationList.firstWhere((d) => d.id== e.toTravelDestinationId.toString());

        obj.Id= multiCityFormList.length+1;
        obj.FromId=int.tryParse(from.id);
        obj.FromName= from.name;
        obj.FromDate = e.startDate;

        obj.ToId=int.tryParse(to.id);
        obj.ToName= to.name;
        obj.ToDate = e.endDate;
        multiCityFormList.add(obj);
      });
      ...
      res.travelRoutes.forEach((e){
        fromDestinationId=e.fromTravelDestinationId;
        toDestinationId=e.toTravelDestinationId;
      });

      fromDestination = destinationList.firstWhere((d) => d.id==fromDestinationId.toString()).name;
      toDestination = destinationList.firstWhere((d) => d.id==toDestinationId.toString()).name;
    }

    // multiFromDestinationId=[50,51];
    // multiToDestinationId=[50,51];
    // multiFromDestinationDate=['17-Nov-2021','17-Nov-2021'];
    // multiToDestinationDate= ['17-Nov-2021','17-Nov-2021'];
    // multiCityFormList=[];
    //
    // for(int i=0; i < multiFromDestinationId.length; i++){
    //   var obj =  MultiCityForm();
    //   var from  = destinationList.firstWhere((e) => e.id==multiFromDestinationId[i].toString());
    //   var to = destinationList.firstWhere((e) => e.id==multiToDestinationId[i].toString());
    //
    //   obj.Id=i+1;
    //   obj.FromId=int.tryParse(from.id);
    //   obj.FromName= from.name;
    //   obj.FromDate = multiFromDestinationDate[i];
    //
    //   obj.ToId=int.tryParse(to.id);
    //   obj.ToName= to.name;
    //   obj.ToDate = multiFromDestinationDate[i];
    //   multiCityFormList.add(obj);
    // }

    hotelAccommodation = res.hotelAccommodation == 1 ? true : false;
    hotelAccommodationByAdminDpt= res.hotelAccommodationByAdminDpt == 1 ? true : false;
    hotelAccommodationAmount = res.hotelAccommodationAmount;
    transport= res.transport == 1 ? true : false;
    transportByAdminDpt= res.transportByAdminDpt == 1 ? true : false;
    transportAmount =res.transportAmount;
    dailyAllowance= res.dailyAllowance == 1 ? true : false;
    dailyAllowanceAmount =res.dailyAllowanceAmount;
    transferAllowance= res.transferAllowance == 1 ? true : false;
    mealAllowance= res.mealAllowance == 1 ? true : false;
    mealAllowanceAmount= res.mealAllowanceAmount;

    guestHouseAccommodation= res.guestHouseAccommodation == 1 ? true : false;
    airTicket= res.airTicket == 1 ? true : false;
    airTicketByAdminDpt= res.airTicketByAdminDpt == 1 ? true : false;
    advanceRequired= res.advancePayment > 0 ? true : false;
    ...
    switch(payment_method.trim().toLowerCase()) {
      case 'bank': {
        _isBankPaymentMethod=true;}break;
      case 'nagad': {
        _isBankPaymentMethod=false;} break;
      default:{
        _isBankPaymentMethod = false;} break;
    }
    ...
    bank_account_number =res.bankAccountNumber;
    bank_account_name =res.bankAccountName;
    bank_branch_name =res.branchName;
    routing_no =res.routingNo;

    firstApprover = res.travelPlanAuthorities.firstWhere((e) => e.authorityOrder==1).employeeId.toString();//'4';
    if(typeOfTravel.toLowerCase().contains('domestic')){
      finalApprover = res.travelPlanAuthorities.firstWhere((e) => e.authorityOrder==2).employeeId.toString(); //
      //finalApprover = '3562';
    }
    else{
      secondApprover=ceoList.firstWhere((e) => e.id=='1').id;//'1';
      finalApprover=res.travelPlanAuthorities.firstWhere((e) => e.authorityOrder==3).employeeId.toString(); // '3562'
    }
