...
class IdCardADScreen extends StatelessWidget {
  final ApiService apiService;
  final GlobalKey<ScaffoldState> scaffoldKey;
  final User currentUser;
  const IdCardADScreen({
    Key key,
      ...
      Column(
        children: [
          ...
          FutureBuilder<IdCardBHDetailsList>(
              future: apiService.getIdCardADDetailList(),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 5,),
                                        Text(
                                          'Line Manager : ${idCardList[idx].lineManager}', //${_colleagues[idx].code}
                                          style: TextStyle(
                                            color: Colors.black45,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 12,
                                        ...
                                        SizedBox(height: 5,),
                                        Text(
                                          'Delivery Date : ${idCardList[idx].deliveryDate}', //${_colleagues[idx].code}
                                          style: TextStyle(
                                            color: Colors.black45,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 12,
                                        ...
                                        SizedBox(height: 5,),
                                        Text(
                                          'Completion Days : ${idCardList[idx].completionDays}', //${_colleagues[idx].code}
                                          style: TextStyle(
                                            color: Colors.black45,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 12,
