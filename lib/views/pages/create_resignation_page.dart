...
class CreateResignationPage extends StatefulWidget {

  @override
  _CreateResignationScreenState createState() => _CreateResignationScreenState();
}

class _CreateResignationScreenState extends State<CreateResignationPage> {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              NeomorphicTextFormField(
                                ...
                                numOfMaxLines: 8,
                                hintText: resignation_application ?? "Description",
                                fontSize: 12,
                              ...
                              _isLoading
                                ...
                                onTapFunction: () async {
                                  ...
                                  try {
                                    ...
                                    final response = await _apiService.applyForResignation(formData);
                                    ...
                                    showSnackBarMessage(
                                      scaffoldKey: _scaffoldKey,
                                      message: "Failed to apply for resignation!",
                                      fillColor: Colors.red,
                                    );
                                    setState(() {
                                      _isLoading = false;
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text("Successfully Applied for Resignation!!!"),
          actions: [
            FlatButton(
              child: new Text("OK"),
              onPressed: () {
