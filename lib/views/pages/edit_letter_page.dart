...
class EditLetterPage extends StatefulWidget {
  ...
  const EditLetterPage({Key key,
  this.myLetter}) : super(key: key);

  @override
  _EditLetterPageState createState() => _EditLetterPageState();
}

class _EditLetterPageState extends State<EditLetterPage> {
  ApiService _apiService;
  EditLetterRequest requestInfo;
  User _currentUser;
  final _scaffoldKey = GlobalKey<ScaffoldState>();
  final _formKey= GlobalKey<FormState>();
  Future<EditLetterRequest> _editLetterRequest;
  ...
  void initState() {
    ...
    _editLetterRequest=_apiService.getEditLetterRequest(widget.myLetter.id);
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child:
                FutureBuilder<EditLetterRequest>(
                    future: _editLetterRequest,
                              ...
                              Form(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      // ))
                                      //     :
                                      Text('Date of Join :  ${requestInfo.employeeDetails.dateOfJoin}'
                                          ,style: TextStyle(
                                            color: Colors.black45,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 12,
                                      ...
                                      Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: DropdownButton<String>(
                                            isDense: true,
                                            underline: SizedBox(),
                                            value: requisition_type, //?? requestInfo.requisitionDetails.requisitionType,
                                            hint: Text('Select Requisition For',
                                              style: TextStyle(fontSize: 12,
                                                  fontWeight: FontWeight.bold,
                                                  color: Colors.grey[500]),),
                                            items: List<DropdownMenuItem<String>>.generate(
                                              (requestInfo.employeeDetails.requisitionFor?.length ?? 0) + 1,
                                                  (idx) =>
                                                  DropdownMenuItem<String>(
                                                    value: idx == 0 ? null : requestInfo.employeeDetails.requisitionFor[idx - 1].key,
                                                    child: Container(
                                                      width: MediaQuery
                                                          .of(context)
                                                          .size
                                                      ...
                                                      child: Text(
                                                        idx == 0 ? "Select Requisition For" : requestInfo.employeeDetails.requisitionFor[idx - 1].value,
                                                        style: TextStyle(
                                                          fontSize: 12,
                                                          fontWeight: FontWeight.bold,
                                                        ),
                                              ...
                                              setState(() {
                                                ...
                                                if(requisition_type !=null){
                                                  ...
                                                  switch(requisition_type) {
                                                    case 'Salary Certificate': reasonList = requestInfo.employeeDetails.salaryCertificate; break;
                                                    case 'Introductory Letter': {reasonList = requestInfo.employeeDetails.introductoryLetter; is_introductory_type=true;print('is_introductory_type: ' + is_introductory_type.toString());} break;
                                                    case 'Invitation Letter': {reasonList = requestInfo.employeeDetails.invitationLetter; is_invitation_type=true;print('is_invitation_type: ' + is_invitation_type.toString());} break;
                                                    case 'Experience Letter': reasonList = requestInfo.employeeDetails.experienceLetter; break;
                                      ...
                                      Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: DropdownButton<String>(
                                            isDense: true,
                                            underline: SizedBox(),
                                            value: reason , //?? requestInfo.requisitionDetails.reason,
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              NeomorphicTextFormField(
                                                key:  Key(passport_no != null ? passport_no.toString() : 'passport_no'),
                                                initVal: passport_no !=null ? passport_no.toString() : null,
                                                inputType: TextInputType.text,
                                              ...
                                              Container(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: DropdownButton<String>(
                                                    isDense: true,
                                                    underline: SizedBox(),
                                                    value: embassy_name,// ?? requestInfo.requisitionDetails.embassyName,
                                                    hint: Text('Select Embassy Name',
                                                      style: TextStyle(fontSize: 12,
                                                          fontWeight: FontWeight.bold,
                                                          color: Colors.grey[500]),),
                                                    items: List<DropdownMenuItem<String>>.generate(
                                                      (requestInfo.employeeDetails.embassy?.length ?? 0) + 1,
                                                          (idx) =>
                                                          DropdownMenuItem<String>(
                                                            value: idx == 0 ? null : requestInfo.employeeDetails.embassy[idx - 1].embassyName,
                                                            child: Container(
                                                              width: MediaQuery
                                                                  .of(context)
                                                                  .size
                                                              ...
                                                              padding: EdgeInsets.only(left: 20),
                                                              child: Text(
                                                                idx == 0 ? "Select Embassy Name" : requestInfo.employeeDetails.embassy[idx - 1].embassyName,
                                                                style: TextStyle(
                                                                  fontSize: 12,
                                                                  fontWeight: FontWeight.bold,
                                                                ),
                                                    ...
                                                    onChanged: (String value) {
                                                      setState(() {
                                                        ...
                                                        if(embassy_name !=null){
                                                          ...
                                                          var embassy = requestInfo.employeeDetails.embassy.firstWhere((e) => e.embassyName==embassy_name,orElse: (()=>null));
                                              ...
                                              !is_other_embassy ? NeomorphicTextFormField(
                                                key: Key(embassy_address != null ? embassy_address : 'embassy_address'),
                                              ...
                                              NeomorphicTextFormField(
                                                key: Key(remarks != null ? remarks : 'remarks'),
                                                initVal:  remarks,
                                                inputType: TextInputType.text,
                                                numOfMaxLines: 3,
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: Text(
                                                      "Click to see your uploaded attachment",
                                                      style: TextStyle(
                                                        fontWeight:
                                                        FontWeight
                                                            .bold,
                                      ...
                                      _isLoading
                                        ...
                                        onTapFunction: () async {
                                          ...
                                          try {
                                            ...
                                            //return;
                                            final response = await _apiService.updateForLetter(formData,requestInfo.requisitionDetails.id);
  ...
  void _setInitialValues(EditLetterRequest requestInfo) {
    requisition_type =requestInfo.requisitionDetails.requisitionType;
    switch(requisition_type) {
      case 'Salary Certificate': reasonList = requestInfo.employeeDetails.salaryCertificate; break;
      case 'Introductory Letter': {reasonList = requestInfo.employeeDetails.introductoryLetter; is_introductory_type=true;print('is_introductory_type: ' + is_introductory_type.toString());} break;
      case 'Invitation Letter': {reasonList = requestInfo.employeeDetails.invitationLetter; is_invitation_type=true;print('is_invitation_type: ' + is_invitation_type.toString());} break;
    ...
    var requestedReason = reasonList.firstWhere((e) => e.key==requestInfo.requisitionDetails.reason,orElse: (()=>null));

    if(requestedReason==null){
      is_other_reason=true;
      reason= reasonList.firstWhere((e) => e.key.toLowerCase().contains('others')).key;
      other_reason =requestInfo.requisitionDetails.reason;
    }
    else{
      is_other_reason=false;
      other_reason=null;
      reason=requestedReason.key;
    }

    if(is_introductory_type || is_invitation_type){
      salary_display=requestInfo.requisitionDetails.salaryDisplay == 1 ? true : false;
      passport_no = requestInfo.requisitionDetails.passportNo;

      dob=dateFormatter.format(DateTime.tryParse(requestInfo.requisitionDetails.dateOfBirth));
      fromDate=dateFormatter.format(DateTime.tryParse(requestInfo.requisitionDetails.startDate));
      StartDate=DateTime.tryParse(requestInfo.requisitionDetails.startDate);
      toDate=dateFormatter.format(DateTime.tryParse(requestInfo.requisitionDetails.endDate));
      EndDate=DateTime.tryParse(requestInfo.requisitionDetails.endDate);

      var requestedEmbassy = requestInfo.employeeDetails.embassy.firstWhere((e) => e.embassyName == requestInfo.requisitionDetails.embassyName,orElse: (()=>null));

      if(requestedEmbassy==null){
        is_other_embassy=true;
        embassy_name = requestInfo.employeeDetails.embassy.firstWhere((e) => e.embassyName.toLowerCase().contains('others')).embassyName;
        other_embassy_name =requestInfo.requisitionDetails.embassyName;
        other_embassy_address =requestInfo.requisitionDetails.embassyAddress;
      }
      else{
        is_other_embassy=false;
        other_embassy_name=null;
        embassy_name=requestedEmbassy.embassyName;
        embassy_address=requestedEmbassy.address;
      }
      remarks = requestInfo.requisitionDetails.remarks;
      attachmentUrl =requestInfo.attachment;
    }
  }
}
