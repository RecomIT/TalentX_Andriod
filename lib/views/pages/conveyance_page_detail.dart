...
class ConveyancePageDetail extends StatefulWidget {
  final Conveyance myConveyance;

  const ConveyancePageDetail({
    Key key,
    this.myConveyance,
  }) : super(key: key);

  @override
  _ConveyancePageDetailState createState() => _ConveyancePageDetailState();
}

class _ConveyancePageDetailState extends State<ConveyancePageDetail> {
  User _currentUser;
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.hasData && !snapshot.hasError) {
                          ...
                          if (conveyanceDetails == null) { 
                            return Text(
                                'Message : No Conveyance Details Available');
                          } else {
                            return Column(
                              children: [
                                Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 5,),
                                              Text(
                                                'Applicable Cost Center : ${conveyanceDetails.applicableCostCenter}',
                                                //${myResignationList[idx].applicationDate}
                                                style: TextStyle(
                                                  color: Colors.black45,
                                                  fontWeight: FontWeight.bold,
                                              ...
                                              SizedBox(height: 10,),
                                              Text(
                                                'Total Incurred Amount : ${conveyanceDetails.totalIncurredAmount.toString()}',
                                                style: TextStyle(
                                                  fontWeight:
                                                  FontWeight.bold,
                                                  fontSize: 12,
                                              ...
                                              SizedBox(height: 5,),
                                              Text(
                                                'Pending for Approval : ${conveyanceDetails.pendingForApproval.toString()}',
                                                style: TextStyle(
                                                  fontWeight:
                                                  FontWeight.bold,
                                                  fontSize: 12,
                                              ...
                                              SizedBox(height: 5,),
                                              Text(
                                                '## Amount For ${DateFormat.MMMM().format(DateTime.now())} ${DateTime.now().year.toString()}',
                                                style: TextStyle(
                                                  fontWeight:
                                                  FontWeight.bold,
                                                  fontSize: 10,
                                              ...
                                              SizedBox(height: 5,),
                                              conveyanceDetails.applicationApproval
                                                  ? Row(
                                                      children: [
                                                        ElevatedButton(
                                                          ...
                                                          onPressed: () async {
                                                            ...
                                                            try {
                                                              final response =
                                                                  await _apiService.approvalConveyanceRequest(_requestId, note, 'Approved');
                                                                      ...
                                                                      actions: [
                                                                        FlatButton(
                                                                          ...
                                                                          onPressed: () {
                                                                            ...
                                                                            Navigator.of(context).pushNamed(CONVEYANCE_PAGE, arguments: ConveyancePageScreen.ConveyanceAwaitingApproval);
                                                                          },
                                                                        ),
                                                                      ],
                                                                    );
                                                        ...
                                                        OutlinedButton(style: OutlinedButton.styleFrom(primary: kPrimaryColor),
                                                          onPressed: () async {
                                                            ...
                                                            setState(() {_isLoading = true;});
                                                            try {
                                                              final response = await _apiService.approvalConveyanceRequest(_requestId, note, 'Reverted');
                                                        ...
                                                        ElevatedButton(
                                                          ...
                                                          onPressed: () async {
                                                            ...
                                                            setState(() {_isLoading = true;});
                                                            try {
                                                              final response = await _apiService.approvalConveyanceRequest(_requestId, note, 'Rejected');
                                                              if (response.statusCode == 200) {
                                                                setState(() {_isLoading = false;});
