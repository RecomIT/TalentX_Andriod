...
class LunchSubscriptionDashboardScreen extends StatefulWidget {
  final ApiService apiService;
  final GlobalKey<ScaffoldState> scaffoldKey;
  final User currentUser;
  const LunchSubscriptionDashboardScreen({
    Key key,
  ...
  @override
  State<LunchSubscriptionDashboardScreen> createState() => _LunchSubscriptionDashboardScreenState();
}

class _LunchSubscriptionDashboardScreenState extends State<LunchSubscriptionDashboardScreen> {
