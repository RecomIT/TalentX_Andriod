...
import 'package:recom_app/views/widgets/conveyance_application_screen.dart';
import 'package:recom_app/views/widgets/conveyance_awaiting_screen.dart';
import 'package:recom_app/views/widgets/conveyance_settlement_screen.dart';
...
class ConveyancePage extends StatefulWidget {
  final ConveyancePageScreen initialScreen;

  const ConveyancePage ({Key key, this.initialScreen}) : super(key: key);

  @override
  _ConveyancePage createState() => _ConveyancePage();
}

class _ConveyancePage extends State<ConveyancePage> {
  final _scaffoldKey = GlobalKey<ScaffoldState>();

  ConveyancePageScreen pageScreen;
  User _currentUser;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              SelectabelSvgIconButton(
                                text: "Conveyance Application",
                                svgFile: "assets/icons/self_leave.svg",
                                onTapFunction: () {
                                  setState(() {
                                    pageScreen = ConveyancePageScreen.ConveyanceApplication;
                                  });
                                },
                                isSelected: pageScreen == ConveyancePageScreen.ConveyanceApplication,
                              ),
                              ...
                              SelectabelSvgIconButton(
                                ...
                                onTapFunction: () {
                                  setState(() {
                                    pageScreen = ConveyancePageScreen.ConveyanceAwaitingApproval;
                                  });
                                },
                                isSelected: pageScreen == ConveyancePageScreen.ConveyanceAwaitingApproval,
                              )
                          ...
                          Row(
                            ...
                            children: [
                              Spacer(flex: 1,),
                              SelectabelSvgIconButton(
                                text: "Conveyances Settlement",
                                svgFile: "assets/icons/self_leave.svg",
                                onTapFunction: () {
                                  setState(() {
                                    pageScreen = ConveyancePageScreen.ConveyanceSettlement;
                                  });
                                },
                                isSelected: pageScreen == ConveyancePageScreen.ConveyanceSettlement,
                              ),
                              Spacer(flex: 15,)
                              // SelectabelSvgIconButton(
                              //   text: "Leave Report",
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).pushNamed(CREATE_CONVEYANCE_PAGE);
        },
      ...
      bottomNavigationBar: RoundedBottomNavBar(
        activeIndex: -1,
        isActive: pageScreen == ConveyancePageScreen.ConveyanceApplication,
      ),
    );
  }
  ...
  Widget _getPageScreen() {
    switch (pageScreen) {
      case ConveyancePageScreen.ConveyanceApplication:
        return
          ConveyanceApplicationScreen(
          scaffoldKey: _scaffoldKey,
          apiService: _apiService,
          currentUser: _currentUser,);

      case ConveyancePageScreen.ConveyanceAwaitingApproval:
        return
          ConveyanceAwaitingScreen(
          scaffoldKey: _scaffoldKey,
          apiService: _apiService,
          currentUser: _currentUser,
        );

      case ConveyancePageScreen.ConveyanceSettlement:
        return
          ConveyanceSettlementScreen(
            scaffoldKey: _scaffoldKey,
            apiService: _apiService,
            currentUser: _currentUser,);
