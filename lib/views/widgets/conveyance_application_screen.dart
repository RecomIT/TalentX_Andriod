...
class ConveyanceApplicationScreen extends StatelessWidget {
  final ApiService apiService;
  final GlobalKey<ScaffoldState> scaffoldKey;
  final User currentUser;
  const ConveyanceApplicationScreen({
    Key key,
