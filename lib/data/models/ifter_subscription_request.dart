...
class IfterSubscriptionRequest {
  String employeeCode;
  String employeeName;
  String employeeRole;
  ...
  IfterSubscriptionRequest.fromJson(Map<String, dynamic> json) {
    ...
    subscriptionRequestTimeLine = json['subscription_request_time_line']??'N/A';
