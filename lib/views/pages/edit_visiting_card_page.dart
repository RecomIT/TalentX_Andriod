...
class EditVisitingCardPage extends StatefulWidget {
  final VisitingCard myVisitingCard;
  const EditVisitingCardPage({Key key,
  this.myVisitingCard}) : super(key: key);

  @override
  _EditVisitingCardPageState createState() => _EditVisitingCardPageState();
}

class _EditVisitingCardPageState extends State<EditVisitingCardPage> {
  ApiService _apiService;
  EditVisitingCardRequest requestInfo;
  User _currentUser;
  ...
  String remarks;
  VisitingCardRequest _visitingCardRequest;
  bool _isLoading = false;
  String note= 'N/A';
  bool isActionCanceled = false;
  Future<EditVisitingCardRequest> _editVisitingCardRequest;

  void initState() {
    if (widget.myVisitingCard == null)
    {
    ...
    _getvisitingCardRequest();
    _editVisitingCardRequest=_apiService.getEditVisitingCardRequest(widget.myVisitingCard.id);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: (widget.myVisitingCard == null)
            ? SizedBox()
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child:
                FutureBuilder<EditVisitingCardRequest>(
                    future: _editVisitingCardRequest,
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      NeomorphicTextFormField(
                                        initVal:short_name?? requestInfo.visitingCardDetails.shortName,
                                      ...
                                      Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: DropdownButton<String>(
                                            isDense: true,
                                            underline: SizedBox(),
                                            value: required_status?? requestInfo.visitingCardDetails.requiredStatus,
                                      ...
                                      Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: DropdownButton<String>(
                                            isDense: true,
                                            underline: SizedBox(),
                                            value: business_unit_head_id?? requestInfo.visitingCardDetails.approvalAuthorityId.toString(),
                                            hint: Text('Business Unit Head',
                                              style: TextStyle(fontSize: 12,
                                                  fontWeight: FontWeight.bold,
                                                  color: Colors.grey[500]),),
                                            items: List<DropdownMenuItem<String>>.generate(
                                              (requestInfo.employeeDetails.businessHeads?.length ?? 0) + 1,
                                                  (idx) =>
                                                  DropdownMenuItem<String>(
                                                    value: idx == 0 ? null : requestInfo.employeeDetails.businessHeads[idx - 1].id.toString(),
                                                    child: Container(
                                                      width: MediaQuery
                                                          .of(context)
                                                          .size
                                                      ...
                                                      padding: EdgeInsets.only(left: 20),
                                                      child: Text(
                                                        idx == 0 ? "Business Unit Head" : requestInfo.employeeDetails.businessHeads[idx - 1].name,
                                                        style: TextStyle(
                                                          fontSize: 12,
                                                          fontWeight: FontWeight.bold,
                                                        ),
                                      ...
                                      Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: DropdownButton<String>(
                                            isDense: false,
                                            underline: SizedBox(),
                                            value:official_address?? requestInfo.visitingCardDetails.officialAddress,
                                            hint: Text('Select Official Address',
                                              style: TextStyle(fontSize: 12,
                                                  fontWeight: FontWeight.bold,
                                                  color: Colors.grey[500]),),
                                            items: List<DropdownMenuItem<String>>.generate(
                                              (requestInfo.employeeDetails.officeAddress?.length ?? 0) + 1,
                                                  (idx) =>
                                                  DropdownMenuItem<String>(
                                                    value: idx == 0 ? null : requestInfo.employeeDetails.officeAddress[idx - 1].key,
                                                    child: Container(
                                                      width: MediaQuery
                                                          .of(context)
                                                          .size
                                                      ...
                                                      padding: EdgeInsets.only(left: 20),
                                                      child: Text(
                                                        idx == 0 ? "Select Official Address" : requestInfo.employeeDetails.officeAddress[idx - 1].value,
                                                        style: TextStyle(
                                                          fontSize: 12,
                                                          fontWeight: FontWeight.bold,
                                                        ),
                                      ...
                                      SizedBox(height:10),
                                      NeomorphicTextFormField(
                                        initVal:official_contact?? requestInfo.visitingCardDetails.officialContact,
                                        inputType: TextInputType.text,
                                        numOfMaxLines: 2,
                                      ...
                                      SizedBox(height:10),
                                      NeomorphicTextFormField(
                                        initVal:official_email?? requestInfo.visitingCardDetails.officialEmail,
                                      ...
                                      SizedBox(height:10),
                                      NeomorphicTextFormField(
                                        initVal:quantity?? requestInfo.visitingCardDetails.quantity.toString(),
                                      ...
                                      SizedBox(height:10),
                                      NeomorphicTextFormField(
                                        initVal:remarks?? requestInfo.visitingCardDetails.remarks,
                                        inputType: TextInputType.text,
                                        numOfMaxLines: 2,
                                      ...
                                      _isLoading
                                        ...
                                        onTapFunction: () async {
                                          ...
                                          if (short_name == null) {
                                            short_name=requestInfo.visitingCardDetails.shortName;
                                          }
                                          if (required_status == null) {
                                            required_status=requestInfo.visitingCardDetails.requiredStatus;
                                          }
                                          if (business_unit_head_id == null) {
                                            business_unit_head_id=requestInfo.visitingCardDetails.approvalAuthorityId.toString();
                                          }
                                          if (official_address == null) {
                                            official_address=requestInfo.visitingCardDetails.officialAddress;
                                          }
                                          if (official_contact == null) {
                                            official_contact=requestInfo.visitingCardDetails.officialContact;
                                          }
                                          if (official_email == null) {
                                            official_email=requestInfo.visitingCardDetails.officialEmail;
                                          }
                                          if (quantity == null) {
                                            quantity=requestInfo.visitingCardDetails.quantity.toString();
                                          }
                                          if (remarks == null) {
                                            remarks=requestInfo.visitingCardDetails.remarks;
                                          }
                                          ...
                                          try {
                                            ...
                                            var formData = FormData.fromMap({
                                               "visiting_card_id": requestInfo.visitingCardDetails.id,
                                            ...
                                            final response = await _apiService.updateForVisitingCard(formData);
  ...
  AlertDialog cardPreview(BuildContext context) {
    return AlertDialog(
      ...
      content: Container(
        margin: EdgeInsets.only(top: 10),
        height: !_visitingCardRequest.employeeBusinessUnit.toLowerCase().contains('red') ? 260 :300,  //redx
          width: 600,
        decoration: BoxDecoration(
            border: Border.all(color: Colors.black26)
        ),
        // color: Colors.red,
        child:!_visitingCardRequest.employeeBusinessUnit.toLowerCase().contains('red') ? shopup() : redex() //redx
      ),
      actions: <Widget>[
        Padding(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        Text(requestInfo.employeeDetails.employeeName??'',
                        ...
                        Text(requestInfo.employeeDetails.employeeRole??'',
                          textAlign: TextAlign.right,
                          style: TextStyle(
                            fontWeight: FontWeight.normal,
                            fontSize: 10,
                        ...
                        Text(requestInfo.employeeDetails.employeeDepartment??'',
                          textAlign: TextAlign.right,
                          style: TextStyle(
                            fontWeight: FontWeight.normal,
                            fontSize: 10,
  ...
  void _getvisitingCardRequest() async {
    var response = await _apiService.getVisitingCardRequest();
    setState(() {
      _visitingCardRequest  = response;
    });
  }
}
