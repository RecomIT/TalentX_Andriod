...
class IfterSubscriptionPageDetail extends StatefulWidget {
  final LunchSubscription myIfterSubscription;

  const IfterSubscriptionPageDetail({
    Key key,
    this.myIfterSubscription,
  }) : super(key: key);

  @override
  _IfterSubscriptionPageDetailState createState() => _IfterSubscriptionPageDetailState();
}

class _IfterSubscriptionPageDetailState extends State<IfterSubscriptionPageDetail> {
  User _currentUser;
  ...
  void initState() {
    ...
    if (widget.myIfterSubscription == null) {
      Navigator.of(context).pushNamedAndRemoveUntil(
        HOME_PAGE,
            (route) => false,
      );
    }
    _requestId = widget.myIfterSubscription.id ;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: (widget.myIfterSubscription == null)
            ? SizedBox()
