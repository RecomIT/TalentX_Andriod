...
class CreateIdCardPage extends StatefulWidget {
  const CreateIdCardPage({Key key}) : super(key: key);

  @override
  _CreateIdCardPageState createState() => _CreateIdCardPageState();
}

class _CreateIdCardPageState extends State<CreateIdCardPage> {
  ApiService _apiService;
  IdCardRequest requestInfo;
  User _currentUser;
  ...
  String reason;
  String remarks;
  Future<IdCardRequest> _idCardRequest;
  ...
  void initState() {
    ...
    _idCardRequest=_apiService.getIdCardRequest();
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child:
                FutureBuilder<IdCardRequest>(
                    future: _idCardRequest,
                                          ...
                                          child: DropdownButton<String>(
                                            ...
                                            hint: Text('Blood Group',
                                              style: TextStyle(fontSize: 12,
                                                  ...
                                                  color: Colors.grey[500]),),
                                            items: List<DropdownMenuItem<String>>.generate(
                                              (requestInfo.bloodGroup?.length ?? 0) + 1,
                                                  (idx) =>
                                                  DropdownMenuItem<String>(
                                                    value: idx == 0 ? null : requestInfo.bloodGroup[idx - 1].key.toString(),
                                                    child: Container(
                                                      width: MediaQuery
                                                          .of(context)
                                                          .size
                                                      ...
                                                      padding: EdgeInsets.only(left: 20),
                                                      child: Text(
                                                        idx == 0 ? "Blood Group" : requestInfo.bloodGroup[idx - 1].value,
                                                        style: TextStyle(
                                                          fontSize: 12,
                                                          fontWeight: FontWeight.bold,
                                                        ),
                                          ...
                                          child: DropdownButton<String>(
                                            ...
                                            hint: Text('Select Reason',
                                              style: TextStyle(fontSize: 12,
                                                  ...
                                                  color: Colors.grey[500]),),
                                            items: List<DropdownMenuItem<String>>.generate(
                                              (requestInfo.reason?.length ?? 0) + 1,
                                                  (idx) =>
                                                  DropdownMenuItem<String>(
                                                    value: idx == 0 ? null : requestInfo.reason[idx - 1].key,
                                                    child: Container(
                                                      width: MediaQuery
                                                          .of(context)
                                                          .size
                                                      ...
                                                      padding: EdgeInsets.only(left: 20),
                                                      child: Text(
                                                        idx == 0 ? "Select Reason" : requestInfo.reason[idx - 1].value,
                                                        style: TextStyle(
                                                          fontSize: 12,
                                                          fontWeight: FontWeight.bold,
                                                        ),
                                      ...
                                      _isLoading
                                        ...
                                        onTapFunction: () async {
                                          ...
                                          try {
                                            ...
                                            final response = await _apiService.applyForIdCard(formData);
