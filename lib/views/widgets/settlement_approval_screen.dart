...
class SettlementApprovalScreen extends StatelessWidget {
  final GlobalKey<ScaffoldState> scaffoldKey;
  final ApiService apiService;
  final User currentUser;

  const SettlementApprovalScreen({Key key,
    this.scaffoldKey,
    this.apiService,
  ...
  Widget build(BuildContext context) {
    ...
    return
      Column(
        children: [
          //SizedBox(height: 20),
          FutureBuilder<SettlementRequestData>(
              future: apiService.getSettlementApproveList(),
              builder: (context, snapshot) {
                if (snapshot.hasData && !snapshot.hasError) {
                  var settlementRequestList = snapshot.data.settlementRequest.toList();
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 5,),
                                        Text(
                                          'Name : ${settlementRequestList[idx].employeeName.capitalize()}', //${_colleagues[idx].code}
                                          style: TextStyle(
                                        ...
                                        SizedBox(height: 5,),
                                        Text(
                                          'Division : ${settlementRequestList[idx].divisionName.capitalize()}', //${_colleagues[idx].code}
                                          style: TextStyle(
                                            color: Colors.black45,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 12,
                                        ...
                                        SizedBox(height: 5,),
                                        Text(
                                          'Department : ${settlementRequestList[idx].departmentName.capitalize()}', //${_colleagues[idx].code}
                                          style: TextStyle(
                                            color: Colors.black45,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 12,
                                        ...
                                        SizedBox(height: 5,),
                                        Text(
                                          'Cost Center : ${settlementRequestList[idx].costCenterName.capitalize()}', //${_colleagues[idx].code}
                                          style: TextStyle(
                                            color: Colors.black45,
                                            fontWeight: FontWeight.bold,
                                            fontSize: 12,
